...
HD_PWD='C:/Users/Onur Ozdemir/pipelined_processor/pipelined_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log absolute_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source absolute_top.tcl -notrace
