...
HD_PWD='C:/Users/Onur Ozdemir/pipelined_processor/pipelined_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log absolute_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source absolute_top.tcl
